...
<body class="bg-light">
	...
	<#include '/WEB-INF/public/sidenav.ftl'>
  <main class="main oh" id="main">
    <#include '/WEB-INF/public/top.ftl'>
    <!-- Header -->
    <div class="header">
      <div class="container">
          ...
          <div id="owl-hero-grid" class="owl-carousel owl-theme owl-carousel--dots-inside">
            ...
            <article class="entry featured-posts-grid__entry">
              <div class="thumb-bg-holder owl-lazy" data-src="/images/blog/featured_grid_slide_1.jpg">
                <img src="/images/blog/featured_grid_slide_1.jpg" alt="" class="d-none">
            ...
            <article class="entry featured-posts-grid__entry">
              <div class="thumb-bg-holder owl-lazy" data-src="/images/blog/featured_grid_slide_2.jpg">
                <img src="/images/blog/featured_grid_slide_2.jpg" alt="" class="d-none">
                <a href="single-post.html" class="thumb-url"></a>
                <div class="bottom-gradient"></div>
              </div>
            ...
            <article class="entry featured-posts-grid__entry">
              <div class="thumb-bg-holder owl-lazy" data-src="/images/blog/featured_grid_slide_3.jpg">
                <img src="/images/blog/featured_grid_slide_3.jpg" alt="" class="d-none">
                <a href="single-post.html" class="thumb-url"></a>
                <div class="bottom-gradient"></div>
              </div>
                      ...
                      <div class="entry__img-holder">
                        <a href="single-post.html">
                          <div class="thumb-container thumb-75">
                            <img data-src="/images/blog/grid_post_img_1.jpg" src="/images/empty.png" class="entry__img lazyload" alt="" />
                          </div>
                        </a>
                      </div>
                  ...
                  <div class="col-md-6">
                    <article class="entry">
                      <div class="entry__img-holder">
                        <a href="single-post.html">
                          <div class="thumb-container thumb-75">
                            <img data-src="/images/blog/grid_post_img_2.jpg" src="/images/empty.png" class="entry__img lazyload" alt="" />
                          </div>
                        </a>
                      </div>
          ...
          <section class="section">
            ...
            <article class="entry post-list">
              <div class="entry__img-holder post-list__img-holder">
                <a href="single-post.html">
                  <div class="thumb-container thumb-75">
                    <img data-src="/images/blog/list_post_img_1.jpg" src="/images/empty.png" class="entry__img lazyload" alt="">
                  </div>
                </a>
              </div>
            ...
            <article class="entry post-list">
              <div class="entry__img-holder post-list__img-holder">
                <a href="single-post.html">
                  <div class="thumb-container thumb-75">
                    <img data-src="/images/blog/list_post_img_2.jpg" src="/images/empty.png" class="entry__img lazyload" alt="">
                  </div>
                </a>
              </div>
            ...
            <article class="entry post-list">
              <div class="entry__img-holder post-list__img-holder">
                <a href="single-post.html">
                  <div class="thumb-container thumb-75">
                    <img data-src="/images/blog/list_post_img_3.jpg" src="/images/empty.png" class="entry__img lazyload" alt="">
                  </div>
                </a>
              </div>
              ...
              <div class="col-lg-7">
                <article class="entry">
                  <div class="entry__img-holder">
                    <a href="single-post.html">
                      <div class="thumb-container thumb-75">
                        <img data-src="/images/blog/editors_post_img.jpg" src="/images/empty.png" class="entry__img lazyload" alt="" />
                      </div>
                    </a>
                  </div>
              ...
              <div class="col-md-6 mb-40">
                ...
                <article class="entry">
                  <div class="entry__img-holder">
                    <a href="single-post.html">
                      <div class="thumb-container thumb-75">
                        <img data-src="/images/blog/grid_post_img_3.jpg" src="/images/empty.png" class="entry__img lazyload" alt="" />
                      </div>
                    </a>
                  </div>
              ...
              <div class="col-md-6 mb-40">
                ...
                <article class="entry">
                  <div class="entry__img-holder">
                    <a href="single-post.html">
                      <div class="thumb-container thumb-75">
                        <img data-src="/images/blog/grid_post_img_4.jpg" src="/images/empty.png" class="entry__img lazyload" alt="" />
                      </div>
                    </a>
                  </div>
              ...
              <div class="col-md-6 mb-40">
                ...
                <article class="entry">
                  <div class="entry__img-holder">
                    <a href="single-post.html">
                      <div class="thumb-container thumb-75">
                        <img data-src="/images/blog/grid_post_img_5.jpg" src="/images/empty.png" class="entry__img lazyload" alt="" />
                      </div>
                    </a>
                  </div>
              ...
              <div class="col-md-6 mb-40">
                ...
                <article class="entry">
                  <div class="entry__img-holder">
                    <a href="single-post.html">
                      <div class="thumb-container thumb-75">
                        <img data-src="/images/blog/grid_post_img_6.jpg" src="/images/empty.png" class="entry__img lazyload" alt="" />
                      </div>
                    </a>
                  </div>
            ...
            <div id="owl-posts" class="owl-carousel owl-theme">
              <article class="entry">
                <div class="entry__img-holder">
                  <a href="single-post.html">
                    <div class="thumb-container thumb-75">
                      <img data-src="/images/blog/carousel_img_1.jpg" src="/images/blog/carousel_img_1.jpg" class="entry__img owl-lazy" alt="" />
                    </div>
                  </a>
                </div>
              ...
              <article class="entry">
                <div class="entry__img-holder">
                  <a href="single-post.html">
                    <div class="thumb-container thumb-75">
                      <img data-src="/images/blog/carousel_img_2.jpg" src="/images/blog/carousel_img_2.jpg" class="entry__img owl-lazy" alt="" />
                    </div>
                  </a>
                </div>
              ...
              <article class="entry">
                <div class="entry__img-holder">
                  <a href="single-post.html">
                    <div class="thumb-container thumb-75">
                      <img data-src="/images/blog/carousel_img_3.jpg" src="/images/blog/carousel_img_3.jpg" class="entry__img owl-lazy" alt="" />
                    </div>
                  </a>
                </div>
	...
	<#include '/WEB-INF/public/footer.ftl'>
